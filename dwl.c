...
virtualkeyboard(struct wl_listener *listener, void *data)
{
	...
	/* Set the keymap to match the group keymap */
	wlr_keyboard_set_keymap(&keyboard->keyboard, group->wlr_group->keyboard.keymap);
	LISTEN(&keyboard->keyboard.base.events.destroy, &group->destroy, destroykeyboardgroup);

	/* Add the new keyboard to the group */
	wlr_keyboard_group_add_keyboard(group->wlr_group, &keyboard->keyboard);
}
